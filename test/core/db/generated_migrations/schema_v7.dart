...
class PetWeights extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> sourceEventUuid = GeneratedColumn<String>(
    'source_event_uuid',
    aliasedName,
    true,
    type: DriftSqlType.string,
...
class EventTags extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  List<GeneratedColumn> get $columns => [id, uuid, label, color, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class EventTagLinks extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EventTagLinks(this.attachedDatabase, [this._alias]);
  ...
  late final GeneratedColumn<int> tagId = GeneratedColumn<int>(
    ...
    requiredDuringInsert: true,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'REFERENCES event_tags (id) ON DELETE CASCADE',
    ),
  );
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'event_tag_links';
  @override
  ...
  @override
  EventTagLinks createAlias(String alias) {
    return EventTagLinks(attachedDatabase, alias);
  }
}

class EventPhotos extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EventPhotos(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  EventPhotos createAlias(String alias) {
    return EventPhotos(attachedDatabase, alias);
  }
}
...
class DatabaseAtV7 extends GeneratedDatabase {
  ...
  late final EventTagLinks eventTagLinks = EventTagLinks(this);
  late final EventPhotos eventPhotos = EventPhotos(this);
  @override
